...
namespace CourierApp.Web.Controllers
{
    public class NotificationController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Message,UserId,CreatedAt")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Message,UserId,CreatedAt")] Notification notification)
        {
